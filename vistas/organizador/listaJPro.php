...
<section id="seccionL">
    <div class="container">
        <div class="heading">
            ...
            <h2><?= i18n("Listado de Jurado Profesional")?></h2>
            <img class="dividerline" src="img/sep.png" alt="separador">
            <h3><br></h3>
            <h3><br></h3>
        </div>
            ...
            <div class="row usuTab">
                ...
                <div class="col-md-3">
                    <?php if($jp["estado"]=="baneado"){
                        echo '<a href="index.php?controller=organizador&amp;action=desbanear&amp;listar=listarJPro&amp;idUsuario='.$jp["dniJP"].'"><button class="submit button" type="button">'.i18n("Desbanear").'</button></a>';
                    }else{
                        echo '<a href="index.php?controller=organizador&amp;action=banear&amp;listar=listarJPro&amp;idUsuario='.$jp["dniJP"].'"><button class="submit button" type="button">'.i18n("Banear").'</button></a>';
                    }
                    ?>
                </div>
            </div>
