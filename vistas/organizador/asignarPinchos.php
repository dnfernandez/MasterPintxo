						...
						<?php foreach($listaPinchos as $pincho):?>
							<div class="col-md-4 asignar">
								<div class="form-group">
									<a target="secundaria" href="index.php?controller=pincho&amp;action=consultarPincho&amp;idPincho=<?php echo $pincho["idPincho"]; ?>#seccionI" class="contact"><?php echo $pincho["nombreP"];?></a>
